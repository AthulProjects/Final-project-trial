...
async function main() {
  await mongoose.connect('mongodb://127.0.0.1:27017/E_Commerce_DB');
...
app.get('/newcollections',async(req,res)=>{
    ...
    console.log("New colllection fetched");
    res.send(newcollection);
})

// creating end point in popular in women
...
//creating endpont to get cart item
